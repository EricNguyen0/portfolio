...
/* ===================== ÆRA COLORWAYS (GALLERY DATA) ===================== */
  "aera.gallery.blackMirror.title": { 
    "en": "Black Mirror", 
    "fr": "Miroir Noir" 
  },
  "aera.gallery.blackMirror.desc": {
  ...
  "aera.gallery.emerald.title": { 
    "en": "Emerald", 
    "fr": "Émeraude" 
  },
  "aera.gallery.emerald.desc": {
    "en": "The Emerald colorway combines a translucent emerald frame with a contrasting gold mirrored lens. This render highlights the relationship between the frame material, lens treatment, and overall product silhouette.",
    "fr": "Le coloris Émeraude combine une monture translucide couleur émeraude avec une lentille miroir dorée contrastante. Ce rendu met en valeur la relation entre le matériau de la monture, le traitement de la lentille et la silhouette globale du produit."
  },
  "aera.gallery.clear.title": { 
    "en": "Clear", 
    "fr": "Transparent" 
  },
